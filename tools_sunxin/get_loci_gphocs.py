...
'''
This script generate fasta and bed files for G-PhoCS.
choose random loci based on G-PhoCS need.
...
def is_loci(chr, st, fa, per_N=0.05) :
    '''
...
if __name__ == '__main__':
    print('In Fasta, out_name, chr_len file, per_N')
